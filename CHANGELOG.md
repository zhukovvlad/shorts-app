...
- **Backend: Атомарное списание кредитов с учетом стоимости модели**
  ...
  - **Улучшен `decreaseCredits`** с атомарной защитой от отрицательного баланса:
    - Санитизация `amount` через `Math.floor()`
    - Валидация `userId` (required check)
  ...
  - Улучшенные сообщения об ошибках при недостаточном балансе
...
- **Testing: Комплексное тестирование системы коэффициентов и списания кредитов**
  ...
  - 19 новых unit-тестов для функции `decreaseCredits` (атомарность, валидация, санитизация)
  ...
  - Тестирование защиты от отрицательного баланса
  - Тестирование санитизации дробных значений
...
### Статистика
- **Измененные файлы:** 5 файлов (основная функциональность) + 5 файлов (nitpicks)
- **Новые файлы:** 2 тестовых файла
- **Добавленные тесты:** 65 тестов (43 коэффициенты + 19 decreaseCredits + 3 robustness)
- **Общее количество тестов:** 229 (все прошли успешно)
