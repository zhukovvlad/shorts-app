...
- **Backend: Атомарное списание кредитов с учетом стоимости модели**
  ...
  - Обновлен helper `decreaseCredits(userId, amount = 1)` для поддержки произвольной суммы
...
- **Testing: Комплексное тестирование системы коэффициентов**
  ...
  - Интеграционные тесты для всех моделей из `IMAGE_MODELS`
  - Файлы: `lib/imageModels-coefficients.spec.ts`
...
- **Новые файлы:** 1 тестовый файл
- **Добавленные тесты:** 43 теста
- **Общее количество тестов:** 207 (все прошли успешно)
